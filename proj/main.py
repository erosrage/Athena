...
from proj.commands import plan, new, dev, build, release, status, mcp, help as help_cmd, lazy, skills, agent, settings
...
def main(ctx: typer.Context):
    if ctx.invoked_subcommand is None:
        ...
        console.print(f"  [cyan]{c} plan[/]     Brainstorm + architect with Claude")
        console.print(f"  [cyan]{c} new[/]      Scaffold a new project")
